...
func (sc stakingClient) Delegate(fromInfo keys.Info, passWd, coinsStr, memo string, accNum, seqNum uint64) (resp types.TxResponse, err error) {
	...
	if err != nil {
		return resp, fmt.Errorf("err : parse Coins [%s] error: %s", coinsStr, err)
	}
...
func (sc stakingClient) Unbond(fromInfo keys.Info, passWd, coinsStr, memo string, accNum, seqNum uint64) (resp types.TxResponse, err error) {
	if err = params.CheckKeyParams(fromInfo, passWd); err != nil {
		return
	}
...
func (sc stakingClient) Vote(fromInfo keys.Info, passWd string, valAddrsStr []string, memo string, accNum, seqNum uint64) (resp types.TxResponse, err error) {
	...
	if err != nil {
		return resp, fmt.Errorf("err : validator address parsed error: %s", err.Error())
	}
...
func (sc stakingClient) DestroyValidator(fromInfo keys.Info, passWd string, memo string, accNum, seqNum uint64) (resp types.TxResponse, err error) {
	if err = params.CheckKeyParams(fromInfo, passWd); err != nil {
		return
	}
